...
//
// fs.readFile('./export-EtherPrice.csv', (error, data) => {
//   const convert = value => Number(value.replace(/\"/g, ''));
...
//       const object = { timestamp: convert(cells[1]), value: convert(cells[2]) };
//       return object;
//     });
//   result.splice(0, 1);
...
//   fs.writeFile(
//     './result',
//     result.map(object => JSON.stringify(object)).join(',\n'),
