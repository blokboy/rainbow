...
const mapStateToProps = ({
  settings: { accountAddress, accountColor, accountName,  chainId, language, nativeCurrency, network },
}) => ({ accountAddress, accountColor, accountName, chainId, language, nativeCurrency, network });
